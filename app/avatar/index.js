...
export { faceSeedPoints } from './faceseed.js';   // a dense seed on the face mesh, next to the sparse cloud   // native windows of the person as extra cameras, between solve and seed
